...
// -------------------------------------
  ...
  // map tile
  var basemap = tileLayer('http://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}', {
    attribution: '&copy Hamon', 
    maxZoom: 16, 
    accessToken: 'pk.eyJ1IjoiZW1pamF5bmUiLCJhIjoiY2lvMWxrbGxrMWFtaXVrbTNmNWE2dWZkZyJ9.1mt_VncCBhOtJSpSsXN96g'});

  // offices
  var locCorp = marker([40.567, -74.609997]);
  var lochcal = marker([33.581108, -86.644748]);
  var lochcin = marker([39.493304, -87.127383]);
  var lochcut = marker([40.60192, -111.988264]);
  var lochcca = marker([43.855202, -79.387218]).bindPopup("Hamon Custodis Cottrell Canada");
  var lochdi = marker([44.9925, -93.449522]).bindPopup("Hamon Deltak, Inc.");
  var locttc = marker([40.378223, -79.846091]).bindPopup("Thermal Transfer Corporation");

  // www.hamonusa.com/locations
  L.basemap.addTo(mapmain);

  L.locCorp.addTo(mapmain)
    .bindPopup("<b>Hamon Corporate Headquarters</b><br />Hamon Custodis, Inc. | <em>Corp &amp; Eastern Office</em><br />Hamon Research Cottrell, Inc.<br />Research Cottrell Cooling, Inc. | <em>Corp &amp; Eastern Office</em>").openPopup();
  L.lochcal.addTo(mapmain).bindPopup("<em><strong>Southern Office</strong></em><br />Hamon Custodis, Inc.<br />Research Cottrell Cooling, Inc.");
  L.lochcin.addTo(mapmain).bindPopup("<em><strong>MidWest Office</strong></em><br />Hamon Custodis, Inc.<br />Research Cottrell Cooling, Inc.");
  L.lochcut.addTo(mapmain).bindPopup("<em><strong>Western Office</strong></em><br />Hamon Custodis, Inc.<br />Research Cottrell Cooling, Inc.");
  L.lochcca.addTo(mapmain);
  L.lochdi.addTo(mapmain);
  L.locttc.addTo(mapmain);
